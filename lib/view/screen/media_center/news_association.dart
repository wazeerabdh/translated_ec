  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<MediaCenterControllerIm>(
        builder: (controller) => HandlingDataView(
            ...
            widget: Scaffold(appBar: AppBar(title: const Text("اخبار الجمعية",style: TextStyle(color: AppColor.white,fontSize: 15),),centerTitle: true,elevation: 0,),
                              ...
                              Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: (){controller.shareContent("https://www.youtube.com/");},
                                  ),
                                  InkWell(
